...
alias      ff='FCASE=   FTYPE=  FXTYPE=  FOPTS="-L ${FOPTS:+$FOPTS}" FARGS="${FARGS:+$FARGS}" _ffind'
alias     fff='FCASE=   FTYPE=f FXTYPE=  FOPTS="-L ${FOPTS:+$FOPTS}" FARGS="${FARGS:+$FARGS}" _ffind'
alias    ffff='FCASE=   FTYPE=f FXTYPE=f FOPTS="-L ${FOPTS:+$FOPTS}" FARGS="${FARGS:+$FARGS}" _ffind'
alias     ffd='FCASE=   FTYPE=d FXTYPE=  FOPTS="-L ${FOPTS:+$FOPTS}" FARGS="${FARGS:+$FARGS}" _ffind'
...
alias     iff='FCASE=-i FTYPE=  FXTYPE=  FOPTS="-L ${FOPTS:+$FOPTS}" FARGS="${FARGS:+$FARGS}" _ffind'
alias    ifff='FCASE=-i FTYPE=f FXTYPE=  FOPTS="-L ${FOPTS:+$FOPTS}" FARGS="${FARGS:+$FARGS}" _ffind'
alias   iffff='FCASE=-i FTYPE=f FXTYPE=f FOPTS="-L ${FOPTS:+$FOPTS}" FARGS="${FARGS:+$FARGS}" _ffind'
alias    iffd='FCASE=-i FTYPE=d FXTYPE=  FOPTS="-L ${FOPTS:+$FOPTS}" FARGS="${FARGS:+$FARGS}" _ffind'
